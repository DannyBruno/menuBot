...
@scheduler.scheduled_job('cron', hour=19, minute=16, second=10, timezone=pytz.timezone('US/Eastern'))
def spinCacheWorker():
...
@scheduler.scheduled_job('cron', hour=19, minute=16, second=45, timezone=pytz.timezone('US/Eastern'))
def spinSendWorker():
