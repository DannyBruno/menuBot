...
#populates with info
scheduler.add_job(pullMenus, 'cron', [diningHallMenuDict, diningHallList], hour=12, minute=31, second=30) #+4 hours ahead to deploy
...
scheduler.add_job(sendToSubscribers, 'cron', hour=12, minute=32, second=10)
