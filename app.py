...
#populates with info
scheduler.add_job(pullMenus, 'cron', [diningHallMenuDict, diningHallList], hour=7, minute=30, second=0) #+4 hours ahead to deploy
...
scheduler.add_job(sendToSubscribers, 'cron', hour=8, minute=31, second=10)
